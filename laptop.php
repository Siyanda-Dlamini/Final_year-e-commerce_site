					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +2276 632 9486</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> nexusgadgets@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
...
<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2017 Nexus Gadgets. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="#">RGI Students</a></span></p>
				</div>
			</div>
		</div>
